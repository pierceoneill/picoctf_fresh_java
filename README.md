...
<div class="row"><div class="col-md-8"><p class="body-sm text-uppercase">Author: LT 'syreal' Jones</p><h4>Description</h4><p class="body-md text-break"><span class=" d-block">Can you get the flag?</span>
<span class=" d-block">Reverse engineer this <a href="https://artifacts.picoctf.net/c/208/KeygenMe.class" download="" target="_blank">Java program</a>.</span></p><hr><p class="text-white m-0 body-xs cursor-default"><i>debug info: [u:302475 e: p: c:271 i:293313]</i></p></div><div class="col-md-4"><h4>Hints <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle-question" class="svg-inline--fa fa-circle-question text-info" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" id="hintToolTip"><path fill="currentColor" d="M256 512c141.4 0 256-114.6 256-256S397.4 0 256 0S0 114.6 0 256S114.6 512 256 512zM169.8 165.3c7.9-22.3 29.1-37.3 52.8-37.3h58.3c34.9 0 63.1 28.3 63.1 63.1c0 22.6-12.1 43.5-31.7 54.8L280 264.4c-.2 13-10.9 23.6-24 23.6c-13.3 0-24-10.7-24-24V250.5c0-8.6 4.6-16.5 12.1-20.8l44.3-25.4c4.7-2.7 7.6-7.7 7.6-13.1c0-8.4-6.8-15.1-15.1-15.1H222.6c-3.4 0-6.4 2.1-7.5 5.3l-.4 1.2c-4.4 12.5-18.2 19-30.6 14.6s-19-18.2-14.6-30.6l.4-1.2zM288 352c0 17.7-14.3 32-32 32s-32-14.3-32-32s14.3-32 32-32s32 14.3 32 32z"></path></svg></h4><div role="group" class="btn-group"><button type="button" data-action="none" title="Hint 1" class="btn-sm btn btn-primary">1</button></div><div class="tab-content"><div class="tab-pane"><p class="body-sm text-break"><span class=" d-block">Use a decompiler for Java!</span></p></div></div></div></div>